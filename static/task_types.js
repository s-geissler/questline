...
class TaskTypesPageController {
  ...
  renderColorPopover(config) {
    return taskTypesRenderColorPopover(this, config);
  }
  ...
  renderCustomFields(tt) {
    return taskTypesRenderCustomFields(this, tt);
  }

  renderField(tt, field) {
    return taskTypesRenderField(this, tt, field);
  }

  renderFieldOptions(tt, field) {
    return taskTypesRenderFieldOptions(this, tt, field);
  }

  renderAddFieldForm(tt) {
    return taskTypesRenderAddFieldForm(this, tt);
  }
